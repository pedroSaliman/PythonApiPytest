...
def test_get_user_with_id_1_check_name_equals_leanne_graham():
    res=requests.get("https://jsonplaceholder.typicode.com/users/1")
    resbody= res.json()
    assert resbody['name'] == 'Leanne Graham'
...
def test_get_user_with_id_1_check_company_name_equals_romaguera_crona():
    res=requests.get("https://jsonplaceholder.typicode.com/users/1")
    resbody= res.json()
    assert resbody['company']['name'] == 'Romaguera-Crona'
...
def test_post_new_post_check_status_code_equals_201():
     new_post = {
        "title": "My mewo new post title",
        "body": "My mewo new post body",
        "userId": 1
            }
